...
import campuschat.wifi.BaseDialog;
import campuschat.wifi.R;
import campuschat.wifi.activity.wifiap.WifiApConst;
import campuschat.wifi.activity.wifiap.WifiapBroadcast;
import campuschat.wifi.activity.wifiap.WifiapBroadcast.NetWorkChangeListener;
import campuschat.wifi.adapter.WifiapAdapter;
import campuschat.wifi.bean.Users;
import campuschat.wifi.dialog.ConnWifiDialog;
import campuschat.wifi.sql.SqlDBOperate;
import campuschat.wifi.sql.UserInfo;
import campuschat.wifi.util.DateUtils;
import campuschat.wifi.util.LogUtils;
import campuschat.wifi.util.SessionUtils;
import campuschat.wifi.util.SharePreferenceUtils;
import campuschat.wifi.util.TextUtils;
import campuschat.wifi.util.WifiUtils;
import campuschat.wifi.util.WifiUtils.WifiCipherType;
