package theliars.nammasit.activity.imagefactory;

import theliars.nammasit.util.ImageUtils;
import theliars.nammasit.view.RotateImageView;
import theliars.nammasit.view.RotateImageView.RotateType;
...
public class ImageFactoryFliter extends ImageFactory {
	...
	private void initFilterList() {
		...
		FilterItem filterItem_1 = new FilterItem(FilterType.默认, "default");
