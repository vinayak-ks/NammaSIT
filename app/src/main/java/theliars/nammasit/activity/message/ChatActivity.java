package theliars.nammasit.activity.message;

import theliars.nammasit.ActivitiesManager;
import theliars.nammasit.BaseApplication;
import theliars.nammasit.activity.ImageBrowserActivity;
import theliars.nammasit.activity.OtherProfileActivity;
import theliars.nammasit.adapter.ChatAdapter;
...
import theliars.nammasit.socket.tcp.TcpClient;
import theliars.nammasit.socket.udp.IPMSGConst;
import theliars.nammasit.sql.SqlDBOperate;
import theliars.nammasit.util.AudioRecorderUtils;
import theliars.nammasit.util.FileUtils;
import theliars.nammasit.util.ImageUtils;
import theliars.nammasit.util.LogUtils;
import theliars.nammasit.util.SessionUtils;
import theliars.nammasit.view.EmoteInputView;
import theliars.nammasit.view.EmoticonsEditText;
import theliars.nammasit.view.MultiListView;
import theliars.nammasit.view.ScrollLayout;
...
public class ChatActivity extends BaseMessageActivity implements OnItemClickListener {
    ...
    public void processMessage(android.os.Message pMsg) {
        switch (pMsg.what) {
            ...
            case IPMSGConst.IPMSG_CONFIRM_FILE_DATA: {
    ...
    private void startRecord() {
        ...
        RECORD_FILENAME = System.currentTimeMillis()
                + theliars.nammasit.util.TextUtils.getRandomNumStr(3);
